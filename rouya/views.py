...
def index(request):
    return render(request,'index_rouya.html')
...
def show_zWeekly_standard(request):
    ...
    return render(request,'rouya_zWeeklyStandard.html',content)
...
def show_progenitor_introduced(request):
    ...
    return render(request,'rouya_introduced.html',content)
...
def zudai_statistics(request):
    ...
    return render(request,'rouya_zudai_statistics.html',content)


def parent_statistics(request):
    return render(request,'rouya_parent_statistics.html')

def shangpin_statistics(request):
    content = {
        'shangpin_statistics':get_sWeekly_statistic()
    }
    return render(request,'rouya_shangpin_statistics.html',content)
...
def show_fWeekly_standard(request):
    ...
    return render(request,'rouya_fWeeklyStandard.html',content)
...
def show_sDaily_standard(request):
    ...
    return render(request,'rouya_sDailyStandard.html',content)
...
def show_sYearly_param(request):
    ...
    return render(request,'rouya_sYearlyParam.html',content)
...
def show_zudai_allParam(request):
    ...
    return render(request,'rouya_show_zd_allParam.html',content)
...
def show_fumudai_allParam(request):
    content = {
        'fmdai_whole_param':get_all_param(4,2) #1为祖代，2为父母代
    }
    return render(request,'rouya_show_fmdai_allParam.html',content)
...
def zdYearly_TtJirou_Param(request):
    ...
    return render(request,'rouya_zdYearly_TtJirouParam.html',content)
...
def fmdYearly_TtJirou_Param(request):
    ...
    return render(request,'rouya_fmdYearly_TtJirouParam.html',content)


def add_whole_param(request):
    return render(request,'rouya_add_whole_param.html')
